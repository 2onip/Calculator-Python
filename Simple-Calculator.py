...
x=25
y=120
# expression_var=StringVar(root)
# expression_var.set("")
entry_result=Entry(root,font="halvatica 20 bold",fg="white",background="#6d7e9c",bd=3,relief=GROOVE)
...
for i in range(9,0,-1):
    ...
    x+=120 #this will increase value of x in each iteration in place method.
    if i==7 :
        x=25
        y=195
    if i==4:
...
for j in sign:
    ...
    y3+=75 #this will increase value of y in each iteration in place method.
